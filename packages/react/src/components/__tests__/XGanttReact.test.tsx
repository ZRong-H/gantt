...
// Mock @huang_zengrong/kingdee-xk-gantt-core
vi.mock("@huang_zengrong/kingdee-xk-gantt-core", () => {
...
describe("XGanttReact", () => {
  ...
  beforeEach(async () => {
    ...
    mockCore = await import("@huang_zengrong/kingdee-xk-gantt-core");
  });
  ...
  it("should create XGantt instance on mount", () => {
    ...
    expect(mockCore.__mockXGantt).toHaveBeenCalledWith(
